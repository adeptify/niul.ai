...
牛来是一个始终置顶、可拖动的 macOS 桌宠。它扫描本机 AI Session，把工作中、等你、闲置、不在线四种状态、判定依据和工作目录集中在头顶气泡中，并通过牛、马或牛马组合的姿态和动作提供不打扰工作的环境反馈。
...
- 马是原创的暖栗棕短绒直立角色，保留半眯眼、紫灰口鼻与蹄、崎岖建模和僵硬手搓动作；固定朝右以和朝左的牛形成一组。
...
- 行情 Provider、缓存和反应规则：`electron/market/`
