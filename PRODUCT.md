...
- 气泡由用户手动展开或收起；点击 Session 前置对应应用或打开工作目录。
...
- 运行期间可用 `⌘⇧U` 显示或隐藏；完整退出后从 Applications 或 Spotlight 重启。
...
- 产品名为“牛来 / niul.ai”。
- 牛尽量保留电影《牛来》中短角、直立、黄色短绒身体、紫灰色口鼻与手脚、半眯方眼和业余手搓 3D 的辨识度；它是原创还原，不冒充官方素材。
